    ...
    <div class="col-lg-8 col-md-8 col-sm-8">
        <section class="panel">
            <header class="panel-heading">
                Liste des profs responsables de classe
                        ...
                        <div class="modal-body" style="z-index: 3600;">
                            <!--Debut du formulaire d'enregistrement-->
                                <form role="form" method="POST" action="../admin/index.php">
                                    ...
                                    <button type="button" class="btn btn-info" name="action" value="USERCHEFSCLASSEenvoyerEmail" onclick="envoyerEmail('respoClasse')">Envoyer email</button>
                                    <button type="button" class="btn btn-primary" name="action" value="USERCHEFSCLASSEenvoyerSMS" onclick="envoyerSMS('respoClasse')">Envoyer SMS</button>
                                    <button type="button" class="btn btn-success" name="action" value="USERCHEFSCLASSEenvoyerNotif" onclick="envoyerNotif('respoClasse')">Envoyer Texto</button>
                                </form>
            ...
            <table class="table">
              ...
              <tbody>
                <?php foreach($chefsRespoClasses as $chefsRespoClasse){
                    
                    ?>
                     <tr class="active">
                         <td><?php echo explode("|", $chefsRespoClasse["profResponsable"])[0];?></td>
                         <td><?php echo explode("|", $chefsRespoClasse["profResponsable"])[1];?></td>
                         <td><?php echo $chefsRespoClasse["libClasse"];?></td>
                         <td><?php echo $chefsRespoClasse["libDepartement"];?></td>
                     </tr>
                <?php } ?>       
              </tbody>
            </table>
