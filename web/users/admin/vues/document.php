...
<!-- debut modal ajouter une cathegorie de document-->
      <div class="modal fade" id="ajouterCategorie" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <form action="controleurAdmin.php" method="post">
                <div class="modal-header">
                  <button type="submit" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                  <h4 class="modal-title" id="myModalLabel">Ajouter une Catégorie de document</h4>
                </div>
                <div class="modal-body">
                  <!-- debut input-->
                  <div class="">
                      ...
                      <div class="col-lg-10">
                        <input class=" form-control" id="libelleTypeCapteur" name="libelleTypeCapteur" type="text" placeholder="Ajouter une catégorie de document" />
                    </div>
                  </div><br/><br/><br/>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <form action="controleurAdmin.php" method="post">
                      <div class="modal-header">
                        <button type="submit" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title" id="myModalLabel">Ajouter un type de Document</h4>
                      </div>
                      <div class="modal-body">
                        <!-- debut input-->
                        <div class="">
...
<div class="container" style="margin-top: 50px; ">
    ...
    <div class="col-lg-5" style="background-color:#d1b993; padding-left:10px; height:300px;margin-left:20px;">
      ...
      <div class="col-lg-3" style="margin-left:20px;background-color:#26c281;">
         ...
         <center>
           <button type="button" class="btn btn-default" data-toggle="modal" data-target="#ajouterCategorie">Ajouter</button>
         </center>
