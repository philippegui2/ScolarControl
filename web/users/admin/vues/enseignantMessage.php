                        ...
                        <div class="modal-body" style="z-index: 3600;">
                            <!--Debut du formulaire d'enregistrement-->
                                <form role="form" method="POST" action="../admin/index.php">
                                    ...
                                    <button type="button" class="btn btn-info" name="action" value="USERCHEFSCLASSEenvoyerEmail" onclick="envoyerEmail('tousEnseignant')">Envoyer email</button>
                                    <button type="button" class="btn btn-primary" name="action" value="USERCHEFSCLASSEenvoyerSMS" onclick="envoyerSMS('tousEnseignant')">Envoyer SMS</button>
                                    <button type="button" class="btn btn-success" name="action" value="USERCHEFSCLASSEenvoyerNotif" onclick="envoyerNotif('tousEnseignant')">Envoyer Texto</button>
                                </form>
